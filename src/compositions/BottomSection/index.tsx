    ...
    <Container>
      <div className='bottom__container-1'>
        <div className='bottom__text-container'>
          <p className='bottom__text'>Наша місія – щоб кожен українець мав можливість отримати допомогу й не залишився наодинці зі своїми проблемами</p>
          <img className='bottom__image-1' src="images/bottom.png" alt="image" />
          <img className='bottom__image-2' src="images/bottom-bg.png" alt="background" />
        </div>
      </div>
      <div className='bottom__container-2'>
        <h2 className='bottom__title'>Підтримайте нашу роботу!</h2>
        <p className='botoom__desc-1'>Усі ваші донати йдуть саме на роботу фонду, заробітні плати ми виплачуємо з коштів грантодавців</p>
